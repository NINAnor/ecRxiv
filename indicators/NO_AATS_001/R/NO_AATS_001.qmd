...
This section creates the key derived variables needed for the indicator calculation.
We first remove plots with missing data for alien species percentages.
