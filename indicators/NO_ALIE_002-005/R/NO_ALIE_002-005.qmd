...
VersionComment: First version to go on ecRxiv, although the same or very similar indicators have been used before in Norwegian assessments for ecosystem condition in mountains and forests.
...
> **Recomended citation**: `r paste(auth, " ", year, ". ", name, " (ID: ", id, ") ", "v. ", version, ". ecRxiv: https://github.com/NINAnor/ecRxiv/tree/main/indicators/NO_ALIE_002-005", sep="")`
