...
folderName: NO_SLIT_002 # Leave to be filled out by ecRxiv during typesetting (name of the folder under 'indicators/'). 
...
#| eval: false
arrow::write_parquet(
  NO_SLIT_002_sim, "data/NO_SLIT_002_sim.parquet"
)
