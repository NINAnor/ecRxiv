...
The environmental covariates used for the model is presented in @fig-covariates.
...
![Covariate effects of pollinators.](../img/PollinatorPredictions.png){#fig-pollCovEffs}

![Pollinator Predictions.](../img/PollinatorPredictions.png){#fig-pollPreds}

![Standard deviation of Pollinator Predictions.](../img/PollinatorPredictionsSD.png){#fig-pollPredsSD}

![Plant species fixed effects.](../img/plantsCovariateFixedEffects.png){#fig-plantModelFixedEffects}

![Plant species land cover effects.](../img/plantsCovariateLandCoverEffects.png){#fig-plantModelFixedEffects}



![Plant species Predictions.](../img/plantSpeciesProbabilities.png){#fig-plantPreds}

![Pollinator Diversity.](../img/pollinatorDiversity.png){#fig-pollDiversity}
