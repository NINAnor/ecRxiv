...
url: https://github.com/NINAnor/ecRxiv/tree/main/indicators/
...
url <- meta |>
  ...
  pull(Value)
url <- paste0(url, extract_folder_name(this_file$path))
...
> **Recommended citation**: `r paste(auth, " ", year, ". ", name, " (ID: ", id, ") ", "v. ", version, ". ecRxiv: ", url, this_file$path, sep="")`
