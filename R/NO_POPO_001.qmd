...
* Formal analysis: [KPA]
* Validation: [KPA, JT, MS]
* Visualization: [KPA]
* Writing – original draft: [KPA]
* Writing – review & editing: [KPA, MS, JT, AAH, AK]
...
**Data processing**
Raw data were curated and cleaned by [KPA, MS]. Code for preprocessing was written by [KPA].

**Statistical analysis**
All analyses were conducted by [KPA] using R, with verification by [MS].

**Visualization**
Figures were produced by [KPA], with input from [MS, JT].

**Reproducibility**
All code was reviewed and validated by [KPA].
