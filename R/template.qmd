...
The pollinator potential indicator provides a spatial measure of ecosystem condition based on estimated pollinator potential and plant–pollinator relationships. Current indicator values vary among nature regions, with mean values ranging from $0.5337$ in West to $0.5851$ in South. The national mean is $0.5855$. These values represent pollinator potential relative to the reference conditions used to calibrate the indicator, rather than absolute pollinator abundance or population size. The uncertainty around the regional estimates is relatively small, with standard deviations ranging from $0.0050$ in South to $0.0118$ in North. Spatial variation is also evident in the proportion of area exceeding the threshold of $0.6$: $32.7\%$ of West, $34.9\%$ of Central, $36.3\%$ of East, $43.3\%$ of North, and $52.2\%$ of South have indicator values $\ge 0.6$. Nationally, $47.1\%$ of the area exceeds this threshold, with South showing the highest proportion and West the lowest.

There still are some plant species we have missed in this indicator. There are some interracting plant species for the pollinators in GRUK datasets that are not covered in semi-natural meadows that are not covered here (see @fig-grukPlusAso). As such, this indicator will adequately represent semi-natural meadows but under- or over-represent other open lowland areas because the likelihood of occurrence of these plant species were not included. Additionally, there are some butterfly genera such as Pararge, Lasiommata, Oeneis, etc. that were also missing from our indicator (see @fig-grukPlusAso). 

Calibration has a clear and important effect on indicator estimates, with the direction and magnitude varying among nature regions and between regional and national reference frameworks. Calibration is therefore necessary to account for differences in reference conditions. The plant-host evaluation also shows that the indicator is related to plant-host richness, meaning that care is needed when combining it with other plant-host indicators to avoid overlapping information.

The indicator is sufficiently developed to provide a spatial assessment of pollinator potential and to compare ecosystem condition among regions, but further work is required. The main immediate task is to propagate uncertainty from the underlying species-distribution models and plant–pollinator interaction data into the final indicator. The use of the indicator alongside other plant-host measures should also be considered carefully because of their potential correlation.
...
To account for regional differences in environmental conditions and species composition, reference sites are stratified into five biogeographic regions  (hence we refer to the regions as nature regions hereafter): Central, East, North, South, and West. The reference condition therefore represents the range of pollinator potential expected under relatively favourable and stable conditions within each region, rather than an assumed historical or pristine baseline.
...
We also assessed whether calibration changes the magnitude of the pollinator potential indicator and whether the magnitude of this change varies among nature regions. We quantified the difference between the calibrated and uncalibrated indicator values and tested whether these differences differed significantly among nature regions. The results are presented as error plots, with separate panels showing the regional and national indicators.
