...
The functional plant community indicator for nitrogen and its 95% CI are slightly below 0.6 indicating that the functional plant community composition deviates more than accepted under good ecological condition. The result is driven by deviations towards low nitrogen values.
...
Different functional plant community indicators for different environmental variables (light, Light, ...) might show a certain degree of co-linearity with one another as they are derived from the very same plant community data.
...
ind.Tyler[duplicated(ind.Tyler[,'species']),"species"]
ind.Tyler.dup <- ind.Tyler[duplicated(ind.Tyler[,'species']),"species"]
ind.Tyler[ind.Tyler$species %in% ind.Tyler.dup,c("Light","Light","Soil_reaction_pH","Nitrogen","Heat_requirement", "Soil_disturbance","Phosphorus","Grazing_mowing","species.orig","species")]
...
ANO.sp.ind <- merge(x=ANO.sp[,c("Species", "art_dekning", "parentglobalid")], 
                    y= ind.dat[,c("species", "Light", "Nitrogen")],
...
# 2 indicator-value indicators: Light, "Nitrogen"
indEll.n=2
